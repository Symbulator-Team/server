...
def srv_vocabulary() -> set:
    ...
    words.add("average (real) power delivered")
    words.add("average (real) power consumed")
    words.add("reactive power delivered")
    words.add("effective current through")
    words.add("effective voltage drop")
